/**
 * Config page — embedded iframe from native dashboard
 */
const configPage = {
    ...
    content.innerHTML = `
      <div class="iframe-page">
        <iframe
          ...
          src="https://dashboard.hermesinthenight.duckdns.org/config"
          title="Config"
          loading="eager"
...
Router.register('/config', configPage.handler.bind(configPage));
