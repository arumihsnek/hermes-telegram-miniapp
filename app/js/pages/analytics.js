/**
 * Analytics page — embedded iframe from native dashboard
 */
const analyticsPage = {
    ...
    content.innerHTML = `
      <div class="iframe-page">
        <iframe
          ...
          src="https://dashboard.hermesinthenight.duckdns.org/analytics"
          title="Analytics"
          loading="eager"
...
Router.register('/analytics', analyticsPage.handler.bind(analyticsPage));
