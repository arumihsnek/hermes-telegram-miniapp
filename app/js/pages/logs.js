/**
 * Logs page — embedded iframe from native dashboard
 */
const logsPage = {
    ...
    content.innerHTML = `
      <div class="iframe-page">
        <iframe
          ...
          src="https://dashboard.hermesinthenight.duckdns.org/logs"
          title="Logs"
          loading="eager"
...
Router.register('/logs', logsPage.handler.bind(logsPage));
